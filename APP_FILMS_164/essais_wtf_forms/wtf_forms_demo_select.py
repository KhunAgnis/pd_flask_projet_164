...
class DemoFormSelectWTF(FlaskForm):
    produits_dropdown_wtf = SelectField('produits (liste déroulante)',
                                      validators=[DataRequired(message="Sélectionner un produit.")],
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_genre = SubmitField("Choix produit")
